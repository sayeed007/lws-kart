...
import EnglishFlag from '../../../public/assets/images/usa.png';
import BengalFlag from '../../../public/assets/images/bd.png';
    ...
    <div className="flex gap-4 items-center">
      ...
      <div className="relative">
        ...
        >
          <Image
            className="max-w-8"
            src={selectedLanguage.language === 'English' ? EnglishFlag : BengalFlag}
            alt="bangla"
            height={100}
            width={165}
          />
            ...
            <ul>
              {
                languages.map(entry => (
                  ...
                  >
                    <Image
                      className="max-w-8"
                      src={entry.language === 'English' ? EnglishFlag : BengalFlag}
                      alt={entry.language}
                      height={100}
                      width={165}
                    />
